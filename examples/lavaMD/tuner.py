...
from paths import TUNER, BENCH, ROOT
...
class ApproxTunerInterface(MeasurementInterface):
    ...
    def run(self, desired_result, input, limit):
        ...
        gcc_cmd = [
            ...
            "-transform-approx",
            "-o",
            f"{TUNER}/examples/{BENCH}/test.mlir",
        ]
        ...
        cmd = [
            ...
            "-import-mlir",
            "-o",
            f"{TUNER}/examples/{BENCH}/test.exec",
        ]
...
if __name__ == "__main__":
    ...
    if args.test_config:
        ApproxTunerInterface(args).test_config()
    else:
