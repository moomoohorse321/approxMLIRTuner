...
from accuracy import get_gt, get_rbo_result, parse_kernel_out
...
class ApproxTunerInterface(MeasurementInterface):
    def __init__(self, args):
        ...
        SDK.populate_orchestration_knobs(1)
    ...
    def run(self, desired_result, input, limit):
        ...
        result.time, result.accuracy = get_rbo_result(get_gt(), run_result.stdout)
